...
def action_1
  ...
  valid_article_id = Helper::IronHideDbUtil.get_one_valid_article_id_by_mobile($parameters["user"]["mobile"])

  it "IH954_articles-comments for unsign test" do
  ...
  it "IH955_articles-comments for signin test" do
